...
public:
	...
	virtual float DoCopyTexture(void* sourceTexture, int sourceWidth, int sourceHeight, void* destinationTexture, int destinationWidth, int destinationHeight);
...
float RenderAPI_OpenGLCoreES::DoCopyTexture(void* sourceTexture, int sourceWidth, int sourceHeight, void* destinationTexture, int destinationWidth, int destinationHeight)
{
	return -1.0f;
	//UNIMPLEMENTED
}
